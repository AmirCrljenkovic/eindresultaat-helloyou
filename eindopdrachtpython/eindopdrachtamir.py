...
def begin():
    print("Er is oorlog uitgebroken in afghanistan Je wilt iets doen, wat ga je doen?")
...
def option_mening():
    print("Doordat je wilt vluchten wordt je nu gezocht door de vijand. Ze willen je dood hebben, wat ga je doen?")
    print("A | Je gaat vluchten.")
    ...
    if choice in answer_A:
        option_vluchten()
    if choice in answer_B:
        print("Je hebt er voor gekozen om jezelf over te geven, je bent doodgeschoten door de soldaten")
        sys.exit()
    else:
        print(required)
        option_mening()
...
def option_paspoortlibanon():
    ...
    if choice in answer_B:
        print("Je hebt je paspoort niet meegenomen. Je wordt opgepakt door de politie, ze gooien je in de gevangenis, daar ga je dood.")
        sys.exit()
    else:
        print(required)
        option_paspoortlibanon()
